...
#ifndef actasp_Clingo5_4_h__guard
#define actasp_Clingo5_4_h__guard

#include <actasp/FilteringQueryGenerator.h>

namespace actasp {

struct Clingo5_4 : public FilteringQueryGenerator {

  Clingo5_4(const std::string& incrementalVar,
